...
/*   Updated: 2017/10/29 18:28:05 by sflinois         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_ant(t_struct *s, int i_paths, int i_rooms, int *movement)
{
	...
	{
		ft_printf("\x1B[38;5;%imL%02i-%s ", ((100 * s->res.f_paths[i_paths]\
	[i_rooms + 1]->ant) / s->nb_ants) + 1, s->res.f_paths[i_paths][i_rooms\
	+ 1]->ant, s->res.f_paths[i_paths][i_rooms]->name);
